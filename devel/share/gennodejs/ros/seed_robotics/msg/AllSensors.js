...
class AllSensors {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('hand_polarity')) {
        this.hand_polarity = initObj.hand_polarity
      }
      else {
        this.hand_polarity = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [hand_polarity]
    bufferOffset = _serializer.string(obj.hand_polarity, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [hand_polarity]
    data.hand_polarity = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.hand_polarity);
  ...
  static Resolve(msg) {
    ...
    if (msg.hand_polarity !== undefined) {
      resolved.hand_polarity = msg.hand_polarity;
    }
    else {
      resolved.hand_polarity = ''
    }
