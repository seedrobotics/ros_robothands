...
(cl:defmethod cl:initialize-instance :after ((m <lone_sensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lone_sensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name seed_robotics-msg:<lone_sensor> is deprecated: use seed_robotics-msg:lone_sensor instead.")))
...
(cl:defmethod fx-val ((m <lone_sensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader seed_robotics-msg:fx-val is deprecated.  Use seed_robotics-msg:fx instead.")
  (fx m))

(cl:ensure-generic-function 'fy-val :lambda-list '(m))
(cl:defmethod fy-val ((m <lone_sensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader seed_robotics-msg:fy-val is deprecated.  Use seed_robotics-msg:fy instead.")
  (fy m))

(cl:ensure-generic-function 'fz-val :lambda-list '(m))
(cl:defmethod fz-val ((m <lone_sensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader seed_robotics-msg:fz-val is deprecated.  Use seed_robotics-msg:fz instead.")
  (fz m))

(cl:ensure-generic-function 'abs-val :lambda-list '(m))
(cl:defmethod abs-val ((m <lone_sensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader seed_robotics-msg:abs-val is deprecated.  Use seed_robotics-msg:abs instead.")
  (abs m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <lone_sensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader seed_robotics-msg:yaw-val is deprecated.  Use seed_robotics-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <lone_sensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader seed_robotics-msg:pitch-val is deprecated.  Use seed_robotics-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'is_present-val :lambda-list '(m))
(cl:defmethod is_present-val ((m <lone_sensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader seed_robotics-msg:is_present-val is deprecated.  Use seed_robotics-msg:is_present instead.")
  (is_present m))

(cl:ensure-generic-function 'is_3D-val :lambda-list '(m))
(cl:defmethod is_3D-val ((m <lone_sensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader seed_robotics-msg:is_3D-val is deprecated.  Use seed_robotics-msg:is_3D instead.")
  (is_3D m))
